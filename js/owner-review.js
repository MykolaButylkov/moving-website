const ownerReviewTranslations = {
    ru: {
        name: "Николай Бутылков",
        badge: "владелец",
        text: `
      Привет!👋 <br>
      Меня зовут Николай Бутылков — я сам лично стою за этим сервисом переездов🚚.<br>
      Если вы читаете это сообщение — значит, вы ищете не просто перевозку, а нормальных людей, с которыми можно
      спокойно договориться, без нервов и сюрпризов.<br>
    ...
    ua: {
      ...
      спокійно домовитись, без стресу та несподіванок.<br>
